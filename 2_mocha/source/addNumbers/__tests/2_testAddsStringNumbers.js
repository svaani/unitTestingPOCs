...
describe("tests all numbers that are provided as strings", function() {
    it('2+3=5', function() {
    ...
    it('bigInt 91942213363574161572522430563301811072406154908250+1=91942213363574161572522430563301811072406154908251', function() {
        ...
        assert.equal(sum, 91942213363574161572522430563301811072406154908251);
    });
